...
public interface AttendanceRepository extends JpaRepository<AttendanceEntity, Integer > {
    ...
    @Query(nativeQuery = true,
            value = "select * from attendance WHERE date >= '2023-06-01'  and date < '2023-07-01';")
    ...
    @Query(nativeQuery = true,
            value = "SELECT IFNULL(SUM(IFNULL(tl.estimate,0)),0) as count FROM task_list tl WHERE tl.status = 5 AND tl.start_date >= '2023-06-01' AND tl.start_date < '2023-07-01' AND tl.user_id = :emp_id GROUP BY tl.user_id;")
